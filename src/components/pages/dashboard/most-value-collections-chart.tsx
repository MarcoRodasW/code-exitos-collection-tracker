...
import { MostValueCollectionsResponse } from '@/lib/types/dashboard/dahsboard.types';
import { Pie, PieChart } from 'recharts';

interface MostValueCollectionsChartProps {
  data: MostValueCollectionsResponse[];
}
...
export default function MostValueCollectionsChart({
  data,
}: MostValueCollectionsChartProps) {
  ...
  return (
    <Card className='flex flex-col'>
      <CardHeader className='items-center pb-0'>
        <CardTitle>Most Value collection</CardTitle>
      </CardHeader>
